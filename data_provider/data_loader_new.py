...
class GroupDataset(Dataset):
    '''
    对原数据集的 wrapper，只保留指定特征
    '''
    def __init__(self, base_dataset, feature_indices):
...
class Dataset_ETT_hour(Dataset):
    def __init__(self, root_path, flag='train', size=None,
        ...
        self.__read_data__()
        self.feature_groups = [
            [0, 2, 6],  # group1: HUFL, MUFL, OT
            [1, 3],     # group2: HULL, MULL
            [4, 5]      # group3: LUFL, LULL
        ]
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        # self.feature_groups = [
        #     [0, 2, 6],  # group1: feature0, feature2, feature6
        #     [1, 3],     # group2: feature1, feature3
        #     [4, 5]      # group3: feature4, feature5
        # ]
